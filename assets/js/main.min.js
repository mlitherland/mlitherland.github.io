...
!function(e,a){var i="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==";e.fn.imagesLoaded=function(t){function n(){var a=e(l),i=e(g);c&&(g.length?c.reject(A,a,i):c.resolve(A)),e.isFunction(t)&&t.call(s,A,a,i)}function r(e){o(e.target,"error"===e.type)}function o(a,t){a.src===i||-1!==e.inArray(a,u)||(u.push(a),t?g.push(a):l.push(a),e.data(a,"imagesLoaded",{isBroken:t,src:a.src}),d&&c.notifyWith(e(a),[t,A,e(l),e(g)]),A.length===u.length&&(setTimeout(n),A.unbind(".imagesLoaded",r)))}var s=this,c=e.isFunction(e.Deferred)?e.Deferred():0,d=e.isFunction(c.notify),A=s.find("img").add(s.filter("img")),u=[],l=[],g=[];return e.isPlainObject(t)&&e.each(t,function(e,a){"callback"===e?t=a:c&&c[e](a)}),A.length?A.bind("load.imagesLoaded error.imagesLoaded",r).each(function(t,n){var r=n.src,s=e.data(n,"imagesLoaded");s&&s.src===r?o(n,s.isBroken):n.complete&&n.naturalWidth!==a?o(n,0===n.naturalWidth||0===n.naturalHeight):(n.readyState||n.complete)&&(n.src=i,n.src=r)}):n(),c?c.promise(s):s}}(jQuery);
jQuery(document).ready(function(n){var t=!1;n(".cd-nav-trigger").on("click",function(e){e.preventDefault(),t||(n(this).parents(".csstransitions").length>0&&(t=!0),n("body").toggleClass("navigation-is-open"),n(".cd-navigation-wrapper").one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",function(){t=!1}))})}),!function(n){"use strict";n(document).ready(function(){function t(){window.location=a}var e=(n(".site-title"),n("body"));setTimeout(function(){e.addClass("loaded")},150);var i=n(".project-assets").children("div");n.each(i,function(t,e){var i=n(this);i.imagesLoaded(function(){setTimeout(function(){i.addClass("loaded")},50+150*t)})});var o=n(".projects-feed .project");n.each(o,function(t,e){var i=n(this);i.imagesLoaded(function(){setTimeout(function(){i.addClass("loaded")},50+50*t)})});var a;n("a").on("click",function(n){return""==this.href||null==this.href?void n.preventDefault():void(-1==this.href.indexOf("#")&&-1==this.href.indexOf("mailto:")&&-1==this.href.indexOf("javascript:")&&"_blank"!=this.target&&(n.preventDefault(),a=this.href,e.removeClass("loaded"),setTimeout(t,250)))})})}(window.jQuery);
